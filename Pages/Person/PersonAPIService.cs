...
namespace FilmClient.Pages.Person
{
    public class PersonAPIService : BaseService<PersonDto>, IPersonService
    {
        ...
        private PersonDto _addResult;
        private Dictionary<string, PersonDto> _getResults;
        public PersonAPIService(IFilmPersonService fservice, IErrorService eservice) : base(eservice)
        {
            _filmPersonService = fservice;
            _addResult = null;
            _getResults = new Dictionary<string, PersonDto>();
